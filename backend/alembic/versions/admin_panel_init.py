...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_users_last_active_at", "users", ["last_active_at"], unique=False
    )
    ...
    op.create_index(
        "ix_admin_logs_event_type", "admin_logs", ["event_type"], unique=False
    )
    op.create_index(
        "ix_admin_logs_created_at", "admin_logs", ["created_at"], unique=False
    )
    op.create_index(
        "ix_admin_logs_event_created",
        "admin_logs",
