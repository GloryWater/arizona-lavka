...
export function Button({
  ...
  const variantStyles = {
    ...
    secondary: 'bg-dark-border hover:bg-dark-border/80 focus:ring-dark-border text-white',
    danger: 'bg-red-600 hover:bg-red-700 focus:ring-red-500 text-white',
    ghost: 'bg-transparent hover:bg-dark-border focus:ring-dark-border text-white',
  };
