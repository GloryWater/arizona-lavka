...
const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ className, type, label, error, icon, iconPosition = 'left', children, 'aria-label': ariaLabel, 'aria-describedby': ariaDescribedby, ...props }, ref) => {
    const baseStyles = 'flex h-11 w-full rounded-lg border border-input bg-background px-4 py-2 ' +
      ...
      'hover:border-ring/50 focus-visible:border-ring';
    ...
    return (
      <div className="w-full">
        ...
        {error && (
          <p id={errorId} className="mt-1.5 text-sm text-destructive flex items-center gap-1.5" role="alert">
...
const Select = forwardRef<HTMLSelectElement, SelectProps>(
  ({ className, label, error, icon, children, 'aria-label': ariaLabel, 'aria-describedby': ariaDescribedby, ...props }, ref) => {
    const baseStyles = 'flex h-11 w-full rounded-lg border border-input bg-background px-4 py-2 ' +
      ...
      'hover:border-ring/50 focus-visible:border-ring pr-10';
