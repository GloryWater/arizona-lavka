...
⚠️ **ВАЖНО**: Этот проект включает расширенные меры безопасности для защиты чувствительных данных:
...
Для информации по безопасной настройке см. [SECURITY_SETUP.md](SECURITY_SETUP.md).
